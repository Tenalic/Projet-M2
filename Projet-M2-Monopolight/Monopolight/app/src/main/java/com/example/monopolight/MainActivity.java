...
// region Buttons
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, AddCoupon.class);
...
// endregion
    ...
    public class threadGetBoard extends Thread
    {
        ...
        public void run()
        {
            String urlGet = "https://monopolym2tnsi.hopto.org:8443/board";
            URL obj = null;
            try {
                obj = new URL(urlGet);
                ConfigSSL.trustAllHosts();
    ...
    public class threatPostBuy extends Thread
    {
        ...
        public void run()
        {
            String urlGet = "https://monopolym2tnsi.hopto.org:8443/account/buy";
            URL obj = null;
            try {
                obj = new URL(urlGet);
                ConfigSSL.trustAllHosts();
    ...
    public class threatPostDice extends Thread
    {
        ...
        public void run()
        {
            String urlGet = "https://monopolym2tnsi.hopto.org:8443/account/dice";
            URL obj = null;
            try {
                obj = new URL(urlGet);
                ConfigSSL.trustAllHosts();
